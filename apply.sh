...
original_author="Dtdavidgit"
original_name="flask_project_template"
original_urlname="Flask_project_template"
original_description="Awesome flask_project_template created by Dtdavidgit" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/flask_project_template "${name}"
...
then
    ...
    echo "then run 'flask_project_template' or 'python -m flask_project_template'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flask_project_template' or 'python -m flask_project_template' or 'poetry run flask_project_template'"
fi
